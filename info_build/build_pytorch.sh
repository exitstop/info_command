...
sudo -H pip3.6 install pyyaml
sudo -H pip3.6 install --upgrade cython
sudo -H pip3.6 install -U setuptools
...
#set(CMAKE_PREFIX_PATH ${CMAKE_PREFIX_PATH} "~/.local/lib/python3.6/site-packages/torch/share/cmake/Torch/")
#-DCMAKE_PREFIX_PATH="${HOME}.local/lib/python3.6/site-packages/torch/lib" .. \
